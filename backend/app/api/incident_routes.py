...
def map_node_to_message(node_name: str) -> str:
    mapping = {
        ...
        "root_cause": "Analyzing symptoms with Gemini to predict root causes...",
        "action_planner": "Generating triage action plan...",
        "summarizer": "Drafting final engineering summary brief..."
    }
